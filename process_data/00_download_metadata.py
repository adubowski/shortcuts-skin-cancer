...
with open(outputFilePath+'.csv', 'w', newline='') as outputStream:
...
import pickle
backupFilePath = os.path.join(data_path, 'meta_backup.pkl')
with open(backupFilePath, 'wb') as outputFile:
    pickle.dump(imageDetails, outputFile)